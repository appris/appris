...
our $execdir = "/opt/Bio/psipred/bin";  # path to PSIPRED V2 binaries
our $datadir = "/opt/Bio/psipred/data"; # path to PSIPRED V2 data files
our $ncbidir = "/opt/Bio/blast/blast-2.2.18/bin";    # path to NCBI binaries (for PSIPRED in addss.pl)
