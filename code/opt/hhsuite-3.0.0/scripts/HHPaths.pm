...
use FindBin;
our $execdir = $FindBin::Bin.'/../../psipred-4.01/bin';  # path to PSIPRED V2 binaries
our $datadir = $FindBin::Bin.'/../../psipred-4.01/data'; # path to PSIPRED V2 data files
our $ncbidir = $FindBin::Bin.'/../../blast-2.2.26/bin';    # path to NCBI binaries (for PSIPRED in addss.pl)
