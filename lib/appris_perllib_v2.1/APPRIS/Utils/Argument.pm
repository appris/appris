...
APPRIS::Utils::Argument - Utility functions for argument handling
...
unnecessarily from the APPRIS::Root or Bio::Root object.

=head1 METHODS

=cut

package APPRIS::Utils::Argument;
...
=head2 rearrange
 ...
 Example   : use APPRIS::Utils::Argument qw(rearrange);
...
sub rearrange {
  ...
  if ( $order eq "APPRIS::Utils::Argument" ) {
