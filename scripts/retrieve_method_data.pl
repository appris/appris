...
unless( defined $apprisdb_conf_file and defined $species and defined $format and defined $output_file )
{
	print `perldoc $0`;
	exit 1;
}
...
=head2 Optional arguments:
	...
	--methods= <List of APPRIS's methods ('firestar,matador3d,spade,corsair,thump,crash,appris,spade'. Default: ALL)>
