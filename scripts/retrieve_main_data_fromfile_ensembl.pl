...
unless ( defined $input_main_file and defined $input_label_file and defined $input_seq_file and defined $output_file )
{
	print `perldoc $0`;
	exit 1;
}
...
sub main()
{
	...
	my ($output_content) = get_appris_annot($main_report, $label_report, $seq_report, $old_main_report);
