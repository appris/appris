...
export APPRIS_TMP_DIR="${APPRIS_HOME}/tmp"

export APPRIS_LOG_DIR="${APPRIS_TMP_DIR}/logs"
...
export APPRIS_METHODS="firestar,matador3d,matador3d2,spade,corsair,corsair_alt,thump,crash,proteo,appris"
...
export APPRIS_PRG_OPT_HHSUITE_SCRIPTS_DIR="${APPRIS_PROGRAMS_OPT_DIR}/hhsuite-2.0.16-linux-x86_64/lib/hh/scripts"
...
export APPRIS_PRG_OPT_HMMER_31b2_BIN_DIR="${APPRIS_PROGRAMS_OPT_DIR}/hmmer-3.1b2-linux-intel-x86_64/binaries/"

export APPRIS_PRG_OPT_PFAMSCAN13_BIN_DIR="${APPRIS_PROGRAMS_OPT_DIR}/PfamScan-1.3"

export APPRIS_PRG_OPT_PFAMSCAN16_BIN_DIR="${APPRIS_PROGRAMS_OPT_DIR}/PfamScan-1.6"
...
export APPRIS_PRG_OPT_SIGNALP_TMP_DIR="${APPRIS_TMP_DIR}"
...
export APPRIS_PROGRAMS_OPT_BIN_DIR="${APPRIS_PRG_OPT_BLAST_BIN_DIR}:${APPRIS_PRG_OPT_HHSUITE_BIN_DIR}:${APPRIS_PRG_OPT_HHSUITE_SCRIPTS_DIR}:${APPRIS_PRG_OPT_PSIPRED_BIN_DIR}:${APPRIS_PRG_OPT_HMMER_31b2_BIN_DIR}:${APPRIS_PRG_OPT_PFAMSCAN16_BIN_DIR}:${APPRIS_PRG_OPT_TMHMM_BIN_DIR}:${APPRIS_PRG_OPT_PHOBIUS_BIN_DIR}:${APPRIS_PRG_OPT_MEMSAT_BIN_DIR}:${APPRIS_PRG_OPT_PRODIV_BIN_DIR}:${APPRIS_PRG_OPT_KALIGN_BIN_DIR}:${APPRIS_PRG_OPT_SIGNALP_BIN_DIR}:${APPRIS_PRG_OPT_TARGETP_BIN_DIR}:${APPRIS_PRG_OPT_PRANK_BIN_DIR}:${APPRIS_PRG_OPT_SLR_BIN_DIR}:${APPRIS_PRG_OPT_CLUSTALW_BIN_DIR}"

export BLASTMAT="${APPRIS_PROGRAMS_DB_DIR}"

export HHLIB="${APPRIS_PROGRAMS_OPT_DIR}/hhsuite-2.0.16-linux-x86_64/lib/hh"
#export HHLIB="${APPRIS_PROGRAMS_OPT_DIR}/hhsuite-3.0.0"

export PERL5LIB="${APPRIS_PRG_OPT_PFAMSCAN16_BIN_DIR}/:${PERL5LIB}"
...
#module load ensembl/ensembl81

export PERL5LIB="${APPRIS_PROGRAMS_MODULES_DIR}/ensembl81/ensembl/modules/:${PERL5LIB}"

export PERL5LIB="${APPRIS_PROGRAMS_MODULES_DIR}/ensembl81/ensembl-compara/modules/:${PERL5LIB}"

export PERL5LIB="${APPRIS_PROGRAMS_MODULES_DIR}/ensembl81/ensembl-variation/modules/:${PERL5LIB}"

export PERL5LIB="${APPRIS_PROGRAMS_MODULES_DIR}/ensembl81/ensembl-functgenomics/modules/:${PERL5LIB}"
